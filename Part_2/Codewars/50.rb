...
# Problem
- Given an array of integers, return the index position such that:
  - The sum of numbers to the left of it is the same as that to the right of it
- Empty array is considered to be 0
- If such index position does not exist, return -1
- If there is more than 1 possible answer, return the smaller index

# Algorithm
- Iterate through the given array with index,
  - Find the sum of elements to the left of the current element
  - Find the sum of the elements to the right of the current element
  - Return the current index position if they are the same
- Return -1
